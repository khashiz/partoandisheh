...
(function($, undefined) {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate, secondary, monthNames, monthNamesShort) {
      ...
      var html = '<div class="ui-datepicker-title uk-flex-1 uk-text-center uk-text-secondary uk-text-small font uk-grid-small uk-grid-divider uk-child-width-1-2" data-uk-grid>';
      var monthHtml = "";

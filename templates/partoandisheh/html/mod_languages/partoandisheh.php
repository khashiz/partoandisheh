...
<?php else : ?>
	<ul class="uk-padding-remove uk-margin-remove uk-flex uk-flex-middle uk-height-1-1 <?php echo $params->get('inline', 1) ? 'lang-inline' : 'lang-block'; ?>" dir="<?php echo JFactory::getLanguage()->isRtl() ? 'rtl' : 'ltr'; ?>">
	<?php foreach ($list as $language) : ?>
		<?php if (!$language->active) : ?>
			<li>

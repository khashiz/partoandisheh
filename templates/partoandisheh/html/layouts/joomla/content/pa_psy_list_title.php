		...
		<?php if ($params->get('show_title')) : ?>
			<h2 itemprop="name" class="uk-h4 uk-margin-remove uk-text-center">
				<?php if ($params->get('link_titles') && ($params->get('access-view') || $params->get('show_noauth', '0') == '1')) : ?>
					<a class="font uk-text-bold uk-text-dark hoverSecondary" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>" itemprop="url">
